...
public class TestDataSender : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            SocketIOManager.Instance.OnSocketConnected += OnWebSocketConnected;
            SocketIOManager.Instance.OnScoreReceived += OnScoreReceived;
        }
    }
    ...
    {
        if (showDebugInfo)
            Debug.Log("Socket.IO connected - TestDataSender ready to send data");
    ...
    private void OnScoreReceived(SocketIOResponse response)
    {
        if (showDebugInfo)
    ...
    public void SendDefaultTest()
    {
        ...
        SocketIOManager.Instance.SendDefaultScore(testScore);
    ...
    public void SendPlatformerTest()
    {
        ...
        SocketIOManager.Instance.SendPlatformerScore(testVictim, testStreak);
    ...
    public void SendAimTest()
    {
        ...
        SocketIOManager.Instance.SendAimScore(aimType, testPrecision);
    ...
    public void SendAimMissTest()
    {
        ...
        SocketIOManager.Instance.SendAimScore(aimType, 0f, 0, 1);
    ...
    public void SendMultitaskingTest()
    {
        ...
        SocketIOManager.Instance.SendMultitaskingScore(testScore, testObstacleBlock, testBarsActive, targetClicks);
    ...
    public void SendObserveTest()
    {
        ...
        SocketIOManager.Instance.SendObserveScore(testScore, testQuestion, testAnswer);
    ...
    public void SendHoldTheWallTest()
    {
        ...
        SocketIOManager.Instance.SendHoldTheWallScore(timeElapsed, testScore);
    ...
    public void SendButtonSamshTest()
    {
        ...
        SocketIOManager.Instance.SendButtonSamshScore(testScore);
    ...
    public void SendStayOnTargetTest()
    {
        ...
        SocketIOManager.Instance.SendStayOnTargetScore(timeElapsed, testScore);
    ...
    /// <summary>
    /// Checks if Socket.IO is ready to send data
    /// </summary>
