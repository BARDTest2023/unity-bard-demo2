...
public class WebSocketTestRunner : MonoBehaviour
{
    ...
    private IEnumerator TestManagersAvailable()
    {
        ...
        {
            Debug.Log("✅ SocketIOManager found");
        }
    ...
    {
        Debug.Log("Test 3: Testing Socket.IO connection...");
    ...
    private IEnumerator TestMessageSending()
    {
        ...
        if (SocketIOManager.Instance != null && SocketIOManager.Instance.IsConnected)
        {
            ...
            SocketIOManager.Instance.SendAimScore("hit", 0.85f);
            messagesSent++;
            yield return new WaitForSeconds(0.5f);
        ...
        {
            Debug.LogWarning("⚠️ Socket.IO not connected - skipping message sending test");
        }
    ...
    private void LogTestResults()
    {
        ...
        Debug.Log($"Socket.IO Connected: {(webSocketConnected ? "✅" : "❌")}");
